...
<html lang="en">
  <head>
    ...
    <title>C Language : QuizHunt</title>
  </head>
...
<div class="timer-container">
  <div class="circle">
    ...
    <div class="container">
      <h2 class="text-center mb-4">C Quiz</h2>
      <div class="jumbotron">
        ...
        <center>
          <label for="text" style="margin-top: 30px"
            >More Quizzes are here -
            <a href="./playquiz.php">Click Here</a></label
          >
        </center>
      </div>
    </div>
    ...
    <!-- Optional JavaScript -->
    <script src="../quizzes/clanguagequiz.js"></script>
